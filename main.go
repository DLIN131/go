...
func main(){
    ...
    router.GET("/sql-select", func(c *gin.Context) {
    ...
    router.GET("/youtube-download", func(c *gin.Context) {
        c.JSON(http.StatusOK, gin.H{
            "data":         "https://www.youtube.com/watch?v=QH2_TGUlwu4",
        })
    })
